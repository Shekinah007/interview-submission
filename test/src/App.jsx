  ...
  return (
    <div className="app">
      ...
      <div className='header'>
        <h1>Verifty Your Account</h1>
        <p className="gray">We are sending an OTP to verify your validate your
      ...
      <p><span className="gray">A SMS has been sent to</span> 303-345-2323</p>
